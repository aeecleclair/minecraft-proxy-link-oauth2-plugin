...
public class DatabaseManager {
    ...
    public void linkAccount(
            ...
            String OAuth2AccountId,
            String OAuth2AccountUsername
    ) {
        String sql="""
            INSERT INTO linked_accounts
            (oauth2_id, oauth2_username, minecraft_uuid) VALUES (?, ?, ?)
            ON DUPLICATE KEY
                UPDATE oauth2_id = ?, oauth2_username = ?""";
    ...
    public OAuth2Account getOAuth2Account(String minecraftUUID) {
        String sql = """
            SELECT oauth2_id, oauth2_username
